import ComplexityTheoryCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "complexity-theory-canonical-lane",
  theoremObject := "Complexity Theory Canonical Lane",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedComplexityClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_complexity_endgame A
